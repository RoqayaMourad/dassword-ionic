...
import { SingleMenuItemWithIconComponent } from '../../_dashboard/_sidebar/single-menu-item-with-icon/single-menu-item-with-icon.component';
...
@NgModule({
  ...
  declarations: [
    ...
    SingleMenuItemWithIconComponent,
  ],
